...
public class PlusOperatorCalculatorTest {

    @Test
    void test_empty_numbers(){
        PlusOperatorCalculator calculator = new PlusOperatorCalculator();
    ...
    private static Stream<Arguments> provideNumbersAndResult() {
        return Stream.of(
                Arguments.of(Arrays.asList(1,2,3,4,5), BigDecimal.valueOf(15)),
                ...
                Arguments.of(Arrays.asList(1234567899, 1234567899, 1234567899), BigDecimal.valueOf(3703703697l))
        );
    }
}
